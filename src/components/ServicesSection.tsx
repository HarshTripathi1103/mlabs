          ...
          {[
            {
              title: "Social Ads",
              description:
                "We create authentic content that delivers true value to your audience.",
              className: "bg-[#FAF8F4] h-full",
            },
            {
              title: "SaaS marketing",
              description:
                "Experts work with your business to find potential customers.",
              className: "bg-[#FAF8F4]",
            },
            {
              title: "Content marketing",
              description:
                "Our content experts will create a digital marketing strategy.",
            ...
            },
            {
              title: "SEO",
              description:
                "Our SEO works — we know how to drive qualified traffic.",
              className: "bg-[#FAF8F4]",
            },
          ].map((card, index) => (
            <motion.div
              ...
              <ServiceCard
                ...
                description={
                  <WordsPullUp
                    ...
                    inView={isInView}
                    className={
                      card.darkMode ? "text-gray-300" : "text-gray-700"
                    }
                    justify="start"
                  />
                }
