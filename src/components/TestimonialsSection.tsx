  ...
  return (
    <section id="results" className="px-6 md:px-12 py-16" ref={sectionRef}>
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 h-full">
        <div
          className="hidden md:block absolute left-1/2 transform -translate-x-1/2 z-10 overflow-hidden"
          style={{
            top: "5%",
            bottom: "15%",
            width: "2px",
          ...
          additionalTestimonials={[
            {
              ...
              testimonial:
                "MLab has transformed our approach to social advertising. Their strategies have delivered consistent growth month over month. The data-driven approach means we're constantly improving and refining our campaigns.",
              name: "Sarah Johnson",
            ...
            },
            {
              ...
              testimonial:
                "Working with MLab has been a game-changer for our startup. They took the time to truly understand our audience and market position. Their strategic insights have helped us establish a solid foundation for sustainable growth.",
              name: "Michael Chen",
              title: "CEO & Founder",
              imageSrc:
          ...
          additionalTestimonials={[
            {
              ...
              testimonial:
                "What sets MLab apart is their deep understanding of analytics. They don't just run campaigns; they constantly analyze performance data to optimize results. This has transformed our acquisition strategy completely.",
              name: "David Miller",
              title: "Product Lead",
              imageSrc:
            ...
            },
            {
              ...
              testimonial:
                "Our e-commerce store has seen phenomenal growth since working with MLab. Their landing page optimizations and retargeting strategies have dramatically improved our conversion rates and average order value.",
              name: "Emma Rodriguez",
